...
class BatchRenameUI:
    ...
    def create_theme_toggle(self):
        theme_frame = ttk.Frame(self.window)
    ...
    def apply_theme(self):
        ...
        if theme == "light":
            ...
            style.configure('TProgressbar', background='#FF6F61')
            self.file_listbox.configure(bg='#FFFFFF', fg='#000000')
            self.preview_listbox.configure(bg='#FFFFFF', fg='#000000')
        else:
            ...
            style.configure('TButton', background='#FF6F61', foreground='#E0E0E0')
            ...
            style.configure('TProgressbar', background='#FF6F61')
            self.file_listbox.configure(bg='#333333', fg='#E0E0E0')
            self.preview_listbox.configure(bg='#333333', fg='#E0E0E0')
    ...
    def update_button(self, text):
        self.rename_button.config(text=text)

    def reset_button(self):
        time.sleep(2)  # Wait for 2 seconds
        self.rename_button.config(text="Rename files")

    def show_error(self, message):
        error_label = ttk.Label(self.window, text=message, foreground="#FF6F61")
    ...
    def create_option_frame(self):
        ...
        self.option_radio1 = ttk.Radiobutton(option_frame, text="Add prefix and/or suffix", variable=self.option_var, value="1", command=self.update_ui)
        self.option_radio1.pack(side=tk.LEFT, padx=(0, 10))
        self.option_radio2 = ttk.Radiobutton(option_frame, text="Swap characters", variable=self.option_var, value="2", command=self.update_ui)
    ...
    def create_prefix_suffix_frame(self):
        ...
        self.prefix_suffix_radio1 = ttk.Radiobutton(prefix_suffix_frame, text="Add prefix", variable=self.prefix_suffix_var, value="1", command=self.update_prefix_suffix_ui)
        self.prefix_suffix_radio1.pack(side=tk.LEFT, padx=(0, 5))
        self.prefix_suffix_radio2 = ttk.Radiobutton(prefix_suffix_frame, text="Add suffix", variable=self.prefix_suffix_var, value="2", command=self.update_prefix_suffix_ui)
        self.prefix_suffix_radio2.pack(side=tk.LEFT, padx=(0, 5))
        self.prefix_suffix_radio3 = ttk.Radiobutton(prefix_suffix_frame, text="Add both", variable=self.prefix_suffix_var, value="3", command=self.update_prefix_suffix_ui)
    ...
    def create_footer(self):
        ...
        az_label = ttk.Label(footer_frame, text="AZ", font=("Arial", 8, "italic", "underline"), foreground="#FF6F61", cursor="hand2")
